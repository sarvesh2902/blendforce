...
export default function Fertilizer() {
  ...
  return (
    <Admin title="Jobs" headerText="Analyze Jobs" image={session.user.image}>
          ...
          <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
            <div className="flex-auto px-4 lg:px-10 py-10">
              {/* <div className=" flex flex-wrap">
                ...
                <div className=" w-full xl:w-5/12 px-1">
                  ...
                  <div className="flex flex-wrap mt-4">
                    ...
                    <div className="md:col-span-2 h-fit sm:sticky top-0">
                      ...
                      {loading ? (
                        ...
                        <LatestJobs jobCount={jobCount} jobs={jobs} />
                      )}
                      <hr className="my-4 md:min-w-full" />
                      <div className="flex justify-center">
                        <button
                          ...
                          type="button"
                          onClick={() => setJobCount(jobCount + 2)}
                        >
                          More Jobs
                        </button>
                      </div>
                ...
                <div className="mt-6">
                  <div className="flex flex-wrap mt-4">
                    <div className="md:col-span-2 h-fit sm:sticky top-0">
                      <hr className="my-4 md:min-w-full" />
                      <div className="flex justify-between mb-4">
                        <div className="flex  bg-red-700 rounded text-white">
                          <RiLiveFill className="pt-2 w-5 h-5" />
                      ...
                      {loading ? (
                        ...
                        <OngoingJobs jobCount={jobCount} jobs={jobs} />
                      )}
                      <hr className="my-4 md:min-w-full" />
                      <div className="flex justify-center">
                        <button
                  ...
                  <div className="flex flex-wrap mt-4">
                    <div className="md:col-span-2 h-fit sm:sticky top-0">
                      ...
                      {loading ? (
                        ...
                        <DoneJobs jobCount={jobCount} jobs={jobs} />
                      )}
                      <hr className="my-4 md:min-w-full" />
                      <div className="flex justify-center">
                        <button
